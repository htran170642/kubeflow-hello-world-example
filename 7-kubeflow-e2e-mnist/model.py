...
def conv_model(features, labels, mode, params):
  ...
  if mode == tf.estimator.ModeKeys.TRAIN:
    ...
    return tf.estimator.EstimatorSpec(mode, training_chief_hooks=[summary_hook], training_hooks=[summary_hook], evaluation_hooks=[summary_hook], loss=loss, eval_metric_ops=eval_metric_ops, train_op=train_op)
